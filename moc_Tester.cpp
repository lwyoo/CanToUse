...
QT_MOC_LITERAL(3, 15, 8), // "readData"
QT_MOC_LITERAL(4, 24, 11), // "onConnected"
QT_MOC_LITERAL(5, 36, 21), // "onTextMessageReceived"
QT_MOC_LITERAL(6, 58, 7) // "message"

    },
    "Tester\0closed\0\0readData\0onConnected\0"
...
void Tester::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Tester::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Tester::closed)) {
                *result = 0;
                return;
            }
        }
